...
import { TrendingUp, Users, Clock, MessageSquare, MoreHorizontal, ChevronDown, CheckCircle } from 'lucide-react';
            ...
            <div className="flex-1 overflow-y-auto p-4">
                ...
                <div className="space-y-3">
                    {ADVISOR_STATS.map((advisor, index) => (
                        <div key={advisor.id} className="bg-white p-3 rounded-xl border border-gray-100 shadow-sm flex items-center justify-between hover:border-blue-200 transition-colors cursor-pointer group">
