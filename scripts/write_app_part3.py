      ...
      <div className="bg-white border-b border-gray-200 sticky top-0 z-50 px-3 md:px-4 py-2 md:py-3 shadow-sm flex justify-center">
        <div className="bg-gray-100 p-1 rounded-full flex gap-1 relative w-full max-w-md md:max-w-none md:w-auto">
          <button 
            ...
            className={`flex items-center justify-center gap-1.5 md:gap-2 px-4 md:px-6 py-1.5 md:py-2 rounded-full text-xs md:text-sm font-bold transition-all flex-1 md:flex-initial ${
              activeTab === 'sales' ? 'bg-white text-emerald-600 shadow-sm' : 'text-gray-500 hover:text-gray-700'
            }`}
          >
          ...
          <button 
            ...
            className={`flex items-center justify-center gap-1.5 md:gap-2 px-4 md:px-6 py-1.5 md:py-2 rounded-full text-xs md:text-sm font-bold transition-all flex-1 md:flex-initial ${
              activeTab === 'prospecting' ? 'bg-white text-blue-600 shadow-sm' : 'text-gray-500 hover:text-gray-700'
            }`}
          >
