        ...
        try {
            ...
            if (error) {
                if (error.code === '23505') {
                    ...
                    setStatus('success');
                    setMessage('¡Ya estás suscrito! Gracias por tu interés.');
                } else {
                    throw error;
                }
            } else {
                setStatus('success');
                setMessage('¡Listo! Te enviaremos las mejores estrategias.');
                setEmail('');
            }
        } catch (err) {
                ...
                <div className="text-center p-8 md:p-12 bg-gradient-to-br from-[#B87333] to-[#5C3D2E] rounded-3xl shadow-xl overflow-hidden relative">
                    ...
                    <div className="relative z-10">
                        ...
                        <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 max-w-md mx-auto">
                            ...
                            >
                                {status === 'loading' ? 'Enviando...' : status === 'success' ? '✓ Suscrito' : 'Unirme ahora'}
                            </button>
                        </form>
