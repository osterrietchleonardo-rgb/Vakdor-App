            ...
            <div className="max-w-7xl mx-auto px-4 md:px-6 py-12 md:py-16">
                <div className="grid md:grid-cols-4 gap-8 md:gap-12">
                    ...
                    <div>
                        ...
                        <div className="flex flex-col gap-3 text-sm">
                            <a href="mailto:hola@vakdor.com" className="flex items-center gap-2 text-[#94A3B8] hover:text-[#B87333] transition-colors">
                                <Mail size={14} />
                                hola@vakdor.com
                            </a>
                            <a href="tel:+5491112345678" className="flex items-center gap-2 text-[#94A3B8] hover:text-[#B87333] transition-colors">
                                <Phone size={14} />
                                +54 9 11 1234-5678
                            </a>
                    ...
                    <div>
                        ...
                        <div className="flex gap-3 mb-6">
                            <a href="#" className="w-10 h-10 rounded-lg bg-[#1E293B] flex items-center justify-center text-[#94A3B8] hover:bg-[#B87333] hover:text-white transition-all">
                                <Linkedin size={18} />
                            </a>
                            <a href="#" className="w-10 h-10 rounded-lg bg-[#1E293B] flex items-center justify-center text-[#94A3B8] hover:bg-[#B87333] hover:text-white transition-all">
                                <Instagram size={18} />
                ...
                <div className="mt-12 pt-8 border-t border-[rgba(184,115,51,0.1)] flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-[#64748B] text-xs">
                        © 2026 Vakdor. Todos los derechos reservados.
                    </p>
