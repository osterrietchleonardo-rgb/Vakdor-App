...
export function Footer() {
    return (
        <footer className="bg-[#0F172A] border-t border-[#B87333]/30">
                ...
                <div className="grid md:grid-cols-4 gap-8 md:gap-12">
                    ...
                    <div>
                        ...
                        <a
                            ...
                            className="inline-block cta-copper px-6 py-3 rounded-xl text-sm font-bold w-full text-center shadow-[0_4px_14px_0_rgba(184,115,51,0.39)] hover:shadow-[0_6px_20px_rgba(184,115,51,0.23)] hover:-translate-y-1 transition-all ease-linear"
                        >
                            Agendar Llamada
                        </a>
                    </div>
