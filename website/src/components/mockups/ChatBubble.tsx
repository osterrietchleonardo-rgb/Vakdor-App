    ...
    return (
        <div className={`flex w-full mb-2 ${isAi ? 'justify-start' : 'justify-end'}`}>
            ...
            >
                ...
                {message.type === 'carousel' && message.cards && (
                    <div className="flex gap-2 overflow-x-auto pb-2 -mx-1 px-1 snap-x">
                        {message.cards.map((card, idx) => (
                            <div
                                key={idx}
                                className="min-w-[200px] md:min-w-[220px] bg-white rounded-lg border border-gray-200 overflow-hidden shadow-sm snap-center"
                            >
